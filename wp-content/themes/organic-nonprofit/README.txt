Organic NonProfit Theme v5.5.2
...
CHANGELOG v5.0.1:
- Minor escaping updates
- Created fallback for custom menu
- Archive title updates
- Added footer text option
- Regenerated translation files

CHANGELOG v5.1:
- Fixed option typo for home donation text
- Added Give WP plugin compatibility
- Added custom header to display on 404 template
- Removed Infinite Scroll
- Minor tweaks and cleanup

CHANGELOG v5.2:
- Better integration of Give WP
- Style tweaks

CHANGELOG v5.2.1:
- Give WP Style tweaks

CHANGELOG v5.2.2:
- Updated mobile menu styles
- Re-organized Give WP files
- General cleanup

CHANGELOG v5.2.3:
- Updated slideshow options
- Updated shortcodes
- Updated posted on function
- Style tweaks
...
CHANGELOG v5.2.5:
- Fixed update notification HTML issue
- Header tweaks
- Style tweaks

CHANGELOG v5.2.6:
- Fixed slideshow if Jetpack not installed
- Moved slideshow category options under home page options
- Style tweaks
...
CHANGELOG v5.4:
- Removed shortcodes
- Updated WordPress gallery styling
- Added required plugins functions

CHANGELOG v5.4.1:
- Fixed z-index style issue with portfolio template featured image
- Style tweaks to contact info
...
CHANGELOG v5.4.4:
- Fixed theme update button
- Fitvids name change

CHANGELOG v5.5:
- Updated dropdown menu JS so they don't extend off screen
- Added admin notification
- General cleanup
- Style tweaks

CHANGELOG v5.5.1:
- Changed item name in theme updater to reflect new download name

CHANGELOG v5.5.2:
- Minor Give plugin style fix

...
<div class="blog-holder shadow radius-full">
	...
	<div class="postarea">
		...
		<div <?php post_class(); ?> id="post-<?php the_ID(); ?>">
			...
			<div class="post-date">
				<p><i class="fa fa-comment"></i> <a href="<?php the_permalink(); ?>#comments"><?php comments_number( esc_html__('Leave a Comment', 'organic-nonprofit'), esc_html__('1 Comment', 'organic-nonprofit'), esc_html__('% Comments', 'organic-nonprofit') ); ?></a></p>
